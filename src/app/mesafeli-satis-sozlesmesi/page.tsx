...
export const metadata: Metadata = { title: "Mesafeli Satış Sözleşmesi - İlanlio" };
...
export default function MesafeliSatisSozlesmesiPage() {
  return (
    <LegalPage title="Mesafeli Satış Sözleşmesi" updatedAt="17 Haziran 2026" sections={SECTIONS}>
      <p>
        Bu Mesafeli Satış Sözleşmesi (&quot;Sözleşme&quot;), İlanlio Platformu üzerinden sunulan ve bedel karşılığı
      ...
      <p>
        <strong>Hizmet Sağlayıcı:</strong> İlanlio (ilanlio.com) (&quot;İlanlio&quot;, &quot;Satıcı/Sağlayıcı&quot;).
        İletişim: <strong>destek@ilanlio.com</strong>.
      </p>
      <p>
        <strong>Alıcı:</strong> İlanlio Platformu üzerinden ücretli bir hizmeti satın alan, üyelik hesabı bulunan
        gerçek veya tüzel kişi (&quot;Alıcı&quot;, &quot;Tüketici&quot;).
      </p>

      <h2 id="konu">2. Sözleşmenin Konusu</h2>
      <p>
        Bu Sözleşme&apos;nin konusu, Alıcı&apos;nın İlanlio Platformu üzerinden elektronik ortamda sipariş verdiği
      ...
      <p>
        ...
        parçasını oluşturur. İlanlio, hizmet kapsamı ve fiyatlandırmayı önceden ilan ederek güncelleme hakkını
        saklı tutar; güncelleme, daha önce tamamlanmış siparişleri etkilemez.
      </p>

      <h2 id="odeme-sekli">4. Ödeme Şekli</h2>
      <p>
        Ödeme, sipariş sırasında Platform&apos;da sunulan ödeme yöntemleri (banka/kredi kartı veya İlanlio&apos;nun
        anlaşmalı olduğu ödeme hizmet sağlayıcıları aracılığıyla) kullanılarak gerçekleştirilir. Ödeme bilgileri,
        İlanlio sunucularında saklanmaz; işlem, ilgili ödeme kuruluşunun güvenli altyapısı üzerinden tamamlanır.
      ...
      <p>
        ...
        <strong>destek@ilanlio.com</strong> adresine yazılı bildirimde bulunmalıdır.
      </p>
      ...
      <p>
        İlanlio, anında ifa edilen dijital hizmetler için sipariş onayı ekranında Alıcı&apos;dan, hizmetin hemen
      ...
      <p>
        ...
        başlanmamışsa, Alıcı&apos;dan tahsil edilen bedel, cayma bildiriminin İlanlio&apos;ya ulaşmasından itibaren{" "}
      ...
      <ul>
        ...
        <li>İlanlio, mücbir sebep hâllerinde (doğal afet, ağır arıza, mevzuat değişikliği vb.) hizmetin ifasını
      ...
      <p>
        ...
        sınırlar dâhilinde Alıcı&apos;nın veya İlanlio&apos;nun yerleşim yerindeki Tüketici Hakem Heyetleri ile
